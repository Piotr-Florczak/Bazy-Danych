...
--
-- Host: 127.0.0.1
-- Czas generowania: 28 Paź 2022, 10:15
...
-- Baza danych: `hotele`
--
CREATE DATABASE IF NOT EXISTS `hotele` DEFAULT CHARACTER SET utf8 COLLATE utf8_polish_ci;
USE `hotele`;
...
(4, 'PiÄtaszek', 1, 1, 'Ul.Jutra 1', 5, '+48 22 364 12 21', 'PiÄtaszek@przyklad.pl', 'www.PiÄtaszek.twoja_domena.pl'),
(5, 'SzeĹcian', 1, 1, 'Ul.SzeĹcienna 42', 4, '+48 22 137 98 65', 'SzeĹcian@przyklad.pl', 'www.SzeĹcian.twoja_domena.pl'),
(6, 'Sioodemka', 1, 2, 'Ul.JaĹminowa 12', 3, '+48 12 987 65 32', 'Sioodemka@przyklad.pl', 'www.Sioodemka.twoja_domena.pl'),
(7, 'O-Ratio', 1, 2, 'Ul.DÄbowa 33', 2, '+48 12 654 32 45', 'O-Ratio@przyklad.pl', 'www.O-Ratio.twoja_domena.pl'),
...
(12, 'TTN', 1, 3, 'Ul.JabĹoni 23', 3, '+48 32 841 84 14', 'TTN@przyklad.pl', 'www.TTN.twoja_domena.pl'),
...
(15, 'Liil', 1, 4, 'Ul.GĹogowa 35', 4, '+48 61 225 44 66', 'Liil@przyklad.pl', 'www.Liil.twoja_domena.pl'),
...
(22, 'Vea', 1, 6, 'Ul.BiaĹa 89', 2, '+48 17 654 32 45', 'Vea@przyklad.pl', 'www.Vea.twoja_domena.pl'),
...
(10, 'Cyprian', 'KiepĹciuch', 1, 6, 'Ul.	Kwiatowa	34', 4, 'AAA 00000010'),
(11, 'Piotr', 'Komputerik', 1, 6, 'Ul.	PomaraĹczowa	6', 3, 'AAA 00000011'),
(12, 'Maria', 'Elmecka', 1, 6, 'Ul.	Zielona	43', 0, 'AAA 00000012'),
(13, 'Dariusz', 'DrzewoĹaz', 2, 7, 'Ul.	St Eve St	34', 1, 'AAA 00000013'),
...
(18, 'MichaĹ', 'KomĂłrczak', 5, 10, 'Ul.	Prekopova	6', 0, 'AAA 00000018'),
(19, 'MirosĹaw', 'Ekspresik', 6, 11, 'Ul.	Lukas Str.	34', 1, 'AAA 00000019'),
(20, 'Dariusz', 'Googlarz', 7, 12, 'Ul.	Rue De Rao	6', 0, 'AAA 00000020'),
(21, 'Milena', 'ZgĹoska', 7, 12, 'Ul.	Rue Di Deo	45', 1, 'AAA 00000021');
